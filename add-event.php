...
<html>
	...
	<body style="background-image: url('style/img/background_add.jpeg')" class="d-flex flex-column" onload="defaultDate()">
		<?php 
            ...
            // the include or require statement takes all the text/code/markup that exists in the specified fil	
        ?>
		<br><br><br>
		<!-- Main -->
		<div class="container-fluid px-2 py-2 flex-grow-1">
			<div class="container-fluid px-2 pt-2">
				<div class="w-100 p-3 shadow-sm rounded bg-light text-dark">
                    ...
                    <!-- <h2 class="pl-3">Hello <?php echo htmlspecialchars($_SESSION["favcolor"]); ?></h2>  -->
                    <!-- <h2 class="pl-3">Hello <?php echo $username."Test"; ?></h2> -->
                ...
                <div class="container shadow-sm p-3 my-2 border-form-override">
                	<!-- Add Event Form -->
                	<form name="add-event" action="" method="post" onsubmit="return addEventValidation()" class="justify-content-center">
						<div class="row">
	                        <div class="col-sm-6">
	                        ...
	                        <div class="col-sm-6">
				                ...
				                <div class="form-group text-center">
				                	<button type="submit" name="addevent-btn" id="addevent-btn" value="Add Event" class="btn btn-primary btn-lg rounded-pill"><i class="fa fa-plus-circle"></i> Add Event</button>
				                </div>
	                        </div>
	                    </div>
                	</form>
