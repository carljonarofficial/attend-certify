...
<html>
<head>
	<title>Privacy Policy | Attend and Certify</title>
    ...
    <div class="main-body container-fluid flex-grow-1 mt-5">
    	<div class="container-fluid px-2 pt-2">
            ...
            <div class="w-100 p-3 shadow-sm rounded bg-light text-dark">
                ...
                <h2 class="pl-3 font-weight-normal">This policy describes the information on how we treat your data on using this system.</h2>
            </div>
            <!-- Privacy Policy Part -->
            <div class="container shadow-sm p-3 my-2 mt-4 border-form-override">
            	<h1>Draft Provisional Privacy Policy</h1>
            	...
            	<h1>Effectivity</h1>
            	<p>This policy shall take effect upon posting on this page and shall remain valid and in force until the duly management approve, change, or revise this draft provisional privacy policy.</p>
            	<h1>Contact Us</h1>
            	<p>If you have any questions about this Privacy Policy, You can contact us:</p>
            	<ul>
            		<li>By email: <a href="mailto:privacy-policy@attend-certify.com">privacy-policy@attend-certify.com</a></li>
            	</ul>
            </div>
        </div>
    </div>
