	                          ...
	                          <tr>
	                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 20px;font-family:'Open Sans',sans-serif;" align="left">
	                              ...
	                              <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
	                                ...
	                                <p style="font-size: 14px; line-height: 140%; text-align: justify;">I am pleasant to inform you that you are invited to the <strong>{$eventTitle}</strong> with the <strong>Theme: {$eventTheme}</strong>. This will be organized at <strong>{$eventVenue}</strong> and will be
	                                  held on <strong>{$eventDate}</strong> from <strong>{$eventTimeInclusive} to {$eventTimeConclusive}</strong>. {$eventDesciption}. The agenda will be {$eventAgenda}.</p>
	                                <p style="font-size: 14px; line-height: 140%; text-align: justify;">&nbsp;</p>
	                                <p style="font-size: 14px; line-height: 140%; text-align: justify;">Please confirm your availability by bring your invitation barcode attached below. </p>
	                                <p style="font-size: 14px; line-height: 140%; text-align: justify;">&nbsp;</p>
	                        ...
	                        <tbody>
	                          <tr>
	                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;" align="left">
	                              ...
	                              <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
	                                <p style="font-size: 14px; line-height: 140%; text-align: center;"><strong>YOUR INVITATION BARCODE</strong></p>
	                              </div>
	                ...
	                <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
	                  <div style="width: 100% !important;">
	                    ...
	                    <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
	                      ...
	                      <table id="invitationBarcode" class="invitationBarcode" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
	                        <tbody>
	                          <tr>
	                              ...
	                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
	                                <tr>
	                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
	                                    ...
	                                    <img align="center" border="0" src="cid:barcodeEmbedded" alt="Barcode" title="Barcode" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;"
	                                      width="600" />
